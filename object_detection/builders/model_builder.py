...
RPN_TYPE_CASCADE = 'cascade_rpn'
RPN_TYPE_ORGIN = 'orginal_rpn'
RPN_TYPE_WITHOUT = 'without_rpn'  # need another boxes replacing the proposal generated by rpn


def build(model_config, is_training, add_summaries=True, rpn_type=None, filter_fn_arg=None, replace_rpn_arg=None,
          add_area_predicted=None):
    ...
    Args:
      ...
      rpn_type' is the type of rpn which is 'cascade_rpn','orign_rpn'
            ...
            generated by rpn
      filter_fn_arg: if not None, the filter_fn with filter_fn_arg will filter the proposals generated by RPN
            after the first_stage_nms. the arg could see the filter_fn arg
    ...
    if meta_architecture == 'faster_rcnn':
        if rpn_type:
            return _build_faster_rcnn_model(model_config.faster_rcnn, is_training,
                                            add_summaries, rpn_type=rpn_type, filter_fn_arg=filter_fn_arg,
